...
var _default$2 = Request;var _Request = new _default$2({
  ...
  codeField: 'code'
    ...
    request = _Request.request;var isType_1 = createCommonjsModule(function (module, exports) {
...
function getAccessCode(params) {
  ...
  if (randomArr && hashArr) {
    ...
    var url = concat$2(_context2 = concat$2(_context3 = concat$2(_context4 = "https://mixin-oauth.firesbox.com/?client_id=".concat(client_id, "&redirect_url=")).call(_context4, redirect_url, "&scope=")).call(_context3, SCOPESTR, "&code_challenge=")).call(_context2, challenge, "&response_type=code");
