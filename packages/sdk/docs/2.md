...
| payment | evoke payment checkout by generate pay scheme-url | `function(params: PARAMS_PAYMENT)` | - |  |
| transfer | evoke transfer checkout by generate pay scheme-url | `function(recipient: string)` | - |  |
