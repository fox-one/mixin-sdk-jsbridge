...
- types
  ...
  bridge.payment(params?: PARAMS_PAYMENT): string | void;
  ```
...
- types
  ...
  bridge.share(type: 'text', txt: string): string | void;
  bridge.share(type: 'image', url: string): string | void;
  bridge.share(type: 'contact', user_id: string): string | void;
  bridge.share(type: 'post', content: string): string | void;
  bridge.share(type: 'app_card', params: PARAMS_SHARE_CARD): string | void;
  bridge.share(type: 'live', params: PARAMS_SHARE_LIVE): string | void;
  ```
